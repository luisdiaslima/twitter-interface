...
A <strong>Interface do Twitter</strong> é uma aplicação web feita em Typescript e ReactJs.
...
- [React-Sticky-Box](https://react-sticky-box.codecks.io/#:~:text=React%20Sticky%20Box%20relies%20on%20position%3A%20sticky.%20It%27s,considered%20%22good%20enough%22%20in%20a%20lot%20of%20cases.)

## :star: Relevante
Esta aplicação foi uma grande e excelente oportunidade para eu aprender bem sobre **styled-components** e também trabalhar a **responsividade** em uma aplicação React, também foram aplicadas diversas e excelentes técnicas sobre como trabalhar com um layout toltamente responsivo, e como ele deve ser.
...
```sh
  $ git clone https://github.com/thisluis/twitter-interface.git
```
